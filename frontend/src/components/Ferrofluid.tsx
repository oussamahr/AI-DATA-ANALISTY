...
const Ferrofluid: React.FC<FerrofluidProps> = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      callIfFn(
        programRef.current as unknown as Record<string, unknown>,
        "remove"
      );
      callIfFn(
        geometryRef.current as unknown as Record<string, unknown>,
        "remove"
      );
      callIfFn(
        meshRef.current as unknown as Record<string, unknown>,
        "remove"
      );
      callIfFn(
        rendererRef.current as unknown as Record<string, unknown>,
        "destroy"
      );
